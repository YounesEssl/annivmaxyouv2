<script lang="ts">
  ...
  const alcohols = [
    ...
    {
      emoji: "🍷",
      text: "Vin rouge & blanc",
      color: "from-red-500/20 to-purple-500/20",
    },
    {
      emoji: "🥃",
      text: "Vodka, rhum, gin, JET 27, Jäger…",
  ...
  onMount(() => {
    ...
    const announcementLines =
      announcementElement.querySelectorAll(".announcement-line");
    gsap.fromTo(
      announcementLines,
      { opacity: 0, x: -40 },
      {
...
>
  ...
  <div class="relative z-10 max-w-7xl mx-auto">
    ...
    <div
      class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-20 sm:mb-24"
    >
      <!-- Annonce -->
      <div bind:this={announcementElement} class="order-2 lg:order-1">
        <div class="relative">
          <!-- Glow -->
          <div
            class="absolute -inset-8 bg-gradient-to-r from-purple-500/30 via-blue-500/30 to-purple-500/30 rounded-full blur-[80px] opacity-50 animate-pulse-slow"
          ></div>
      ...
      <div bind:this={imageElement} class="opacity-0 order-1 lg:order-2">
        <div class="relative">
          <!-- Glow -->
          <div
            class="absolute -inset-2 bg-gradient-to-r from-purple-500/20 via-blue-500/20 to-purple-500/20 rounded-3xl blur-2xl opacity-70"
          ></div>
      ...
      >
        {#each alcohols as alcohol}
          <div class="alcohol-card opacity-0">
            <div
              class="p-6 sm:p-8 rounded-3xl border border-white/10 bg-gradient-to-br {alcohol.color} backdrop-blur-sm"
            >
              <div class="flex flex-col items-center text-center gap-4">
                ...
                <!-- Texte -->
                <p
                  class="text-lg sm:text-xl text-white/90 font-light leading-relaxed"
                >
                  {alcohol.text}
                </p>
              </div>
    ...
    <div bind:this={dividerElement} class="mb-16 sm:mb-20">
      <div class="flex items-center justify-center gap-6">
        <div
          class="divider-line h-px w-full max-w-xs bg-gradient-to-r from-transparent via-purple-500/60 to-purple-500/60"
          style="transform-origin: left;"
        ></div>

        <div class="flex gap-3">
          <div
            class="divider-dot w-3 h-3 rounded-full bg-gradient-to-r from-purple-500 to-blue-500"
          ></div>
          <div
            class="divider-dot w-3 h-3 rounded-full bg-gradient-to-r from-blue-500 to-purple-500"
          ></div>
          <div
            class="divider-dot w-3 h-3 rounded-full bg-gradient-to-r from-purple-500 to-blue-500"
          ></div>
        ...
        <div
          class="divider-line h-px w-full max-w-xs bg-gradient-to-r from-purple-500/60 to-transparent"
      ...
      <div class="flex flex-wrap justify-center items-center gap-4 sm:gap-6">
        {#each softs as soft}
          <div class="soft-badge opacity-0">
            {#if soft === "etc…"}
              <span
                class="inline-block px-6 py-3 text-xl sm:text-2xl md:text-3xl font-light text-white/40"
              >
                {soft}
              </span>
            {:else}
    ...
    <div
      bind:this={waterNoteElement}
      class="opacity-0 text-center max-w-2xl mx-auto"
    >
      <div
